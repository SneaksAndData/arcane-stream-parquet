...
{{/*
Generate the Parquet Stream CR viewer cluster role name
*/}}
{{- define "app.clusterRole.parquetStreamViewer" -}}
{{- if .Values.rbac.clusterRole.parquetStreamViewer.nameOverride }}
{{- .Values.rbac.clusterRole.parquetStreamViewer.nameOverride }}
{{- else }}
...
*/}}
{{- define "app.clusterRole.parquetStreamEditor" -}}
{{- if .Values.rbac.clusterRole.parquetStreamEditor.nameOverride }}
{{- .Values.rbac.clusterRole.parquetStreamEditor.nameOverride }}
{{- else }}
